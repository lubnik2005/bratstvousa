			...
			<div class="col-md-6 col-lg-3">
				<div class="team-wrap rounded border p-3">
					<div class="team-member text-center">
						...
						<h5 class="team-title">{member.last_name}<br/>{member.first_name}</h5>
						<p class="text-muted" style="line-height: 1.5; min-height: calc(1.5em * 3); ">{member.role}</p>
						<div class="social">
							...
							<a href={member.viber} title="Viber">
								<img
									src="{data.media_url}img/viber.svg"
									alt="Viber"
									style="width: 20px;"
								/>
							</a>
