...
{#if data.event?.use_editorjs || data.event?.content}
  <div class="container mb-5">
    <div class="blog-content card shadow-sm border-0">
      ...
      <div class="printable">
        {#each schedule as day}
          ...
          <div class="table-responsive">
            <table class="table table-striped align-middle shadow-sm schedule-table">
              <thead>
                <tr>
...
<style>
  ...
  .hero {
    background:
      radial-gradient(1200px 400px at 50% -120px, rgba(13,110,253,.12), transparent),
      linear-gradient(180deg, rgba(33,37,41,.02), transparent 40%);
  }

  /* Capacity card sizing */
  .capacity { max-width: 520px; }
  ...
  @media print {
    ...
    .container-xxl.hero .btn { display: none !important; }
