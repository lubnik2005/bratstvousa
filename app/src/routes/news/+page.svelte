              ...
              <div class="row g-4">
                {#each data.youth_news_articles as article}
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <img class="img-fluid" src="http://192.168.7.61:7128/storage/{article.thumbnail}" alt="">
                                <div class="bg-light p-4">
                                    <a class="d-block h5 lh-base mb-4" href="">{article.title}</a>
                                    <div class="text-muted border-top pt-4">
                                        <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Admin</small>
                                        <small class="me-3"><i class="fa fa-calendar text-primary me-2"></i>{article.date}</small>
                                    </div>
                                </div>
                            </div>
                {/each}
