...
A rule says: *"Youth from **this church**, registering for **this event**, may
pay **this amount** in cash at the door, and should use **this Zeffy discount
code** to get a $0 ticket."*
...
for that event and an active rule exists, the registration is created with
**Cash Eligible = Yes** and **Event Price / Due** = the rule's Amount.

**In the approval email** — cash-eligible registrants get a yellow note that
their total on Zeffy will be $0 and they will pay at the door.
