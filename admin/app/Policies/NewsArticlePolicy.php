...
class NewsArticlePolicy
{
    ...
    {
        return $user->hasPermissionTo('view news_articles');
    }
    ...
    {
        return $user->hasPermissionTo('create news_articles');
    }
    ...
    {
        return $user->hasPermissionTo('edit news_articles');
    }
    ...
    {
        return $user->hasPermissionTo('delete news_articles');
    }
